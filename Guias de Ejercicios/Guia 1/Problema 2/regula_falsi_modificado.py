...
def regula_falsi_con_historial(a, b, tolerancia=1e-5, tipo_error='absoluto', max_iter=100):
    """
    Metodo de regla falsi que retorna historial de errores e iteraciones
    """
    if f(a) * f(b) >= 0:
